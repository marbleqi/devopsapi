...
/**KONG路由基类 */
export abstract class KongRouteBaseEntity extends CommonBaseEntity {
  /**创建时间 */
...
export class KongRouteEntity extends KongRouteBaseEntity {
  /**服务ID */
...
export class KongRouteLogEntity extends KongRouteBaseEntity {
  /**日志ID */
  @PrimaryGeneratedColumn({
    type: 'bigint',
    name: 'log_id',
